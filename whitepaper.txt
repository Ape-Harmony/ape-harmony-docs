...
2. Ape Harmony implements an insurance policy on every lien contract called "Best of 3" guarantee explained in detail below. This guarantee allows lenders to speculate on liens by purchasing them at a discount, but are cashed out at full price when the lien is dissolved. This discount shopping strategy allows for much greater yield than a simple accrued interest model.
